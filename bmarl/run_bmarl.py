'''
Code for benchmarking multi-agent reinforcement learning algorithms on VMAS tasks.
Used BenchMarl tool.
Adapted to train on GPU.
Evaluates the algorithms MAPPO, IPPO, MASAC and MADDPG on Balance and Reverse Transport tasks.  
'''
