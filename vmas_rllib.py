...
class VideoSavingCallbacks(DefaultCallbacks):
    def __init__(self, *args, **kwargs):
        ...
        self.frames = []
        self.iteration_counter = 50  # Counter to track the iteration number for video saving
    ...
    def on_episode_step(
        ...
        **kwargs,
        ...
        # Collect frames during the evaluation episode
    ...
    def on_episode_end(
        ...
        **kwargs,
        ...
        if len(self.frames) > 0:
            ...
            # Define video writer and save frames as video
            ...
            # Increase the iteration counter after saving the video
...
def train():
    ...
    checkpoint_path = "C:/Users/danie/Desktop/UNI-4ano/TSI/rllib_logdir/PPO_2024-12-05_03-21-13/PPO_balance_fb7ee_00000_0_2024-12-05_03-21-14/checkpoint_000050"
